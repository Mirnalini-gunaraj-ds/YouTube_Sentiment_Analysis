...
def analyze():
    ...
    total_positive_comments, total_negative_comments = df_to_senti.sentiment(df)
    ...
    positive_wordcloud = WordCloud(width=800, height=400).generate(" ".join(total_positive_comments.split()))
    ...
    negative_wordcloud = WordCloud(width=800, height=400).generate(" ".join(total_negative_comments.split()))
    plt.figure(figsize=(8, 4))
